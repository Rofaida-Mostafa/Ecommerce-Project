  ...
  return (
    <>
      ...
      <Helmet>
        ...
        {error ? (
          <div
            className="relative  mt-[9vh] text-center  w-[500px]  md:w-[800px] h-fit m-3 p-4 mb-4  text-red-800 rounded-lg bg-yellow-50 font-bold dark:bg-red-100 dark:text-red-700"
            role="alert"
          >
            {error}
          </div>
